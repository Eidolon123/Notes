...
int main()
{
  ...
  cout << "Please enter your order in the format:" << endl;
  cout << "{Pharmacy Name},{Pharmacy Number},{Medicine Required},{Number of Boxes},{Currency}" << endl;
  cout << "Each field should be seperated by a comma" << endl;
